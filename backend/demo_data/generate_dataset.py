...
def generate_sample_datasets(n_samples: int = 2000, seed: int = 42) -> None:
    """
    Generate 3 sample datasets with varying poison levels for demo/testing:

    1. clean          — 0% poison (completely clean data)
    2. mixed_poison   — 25% poison (mix of clean and malicious)
    3. moderate_poison — 40% poison (moderate contamination for demo)
    """
    ...
    configs = [
        {
            "label": "clean",
            "poison_rate": 0.0,
            "filename": "demo_upi_fraud_clean.csv",
            "description": "0% poison — completely clean dataset",
        },
        {
            "label": "mixed_poison",
            "poison_rate": 0.25,
            "filename": "demo_upi_fraud_25pct_mixed.csv",
            "description": "25% poison — mixed clean and malicious data",
        },
        {
            "label": "moderate_poison",
            "poison_rate": 0.40,
            "filename": "demo_upi_fraud_40pct_poison.csv",
            "description": "40% poison — moderate contamination for demo",
        },
    ]

    print("Generating sample UPI fraud datasets...\n")
    for cfg in configs:
